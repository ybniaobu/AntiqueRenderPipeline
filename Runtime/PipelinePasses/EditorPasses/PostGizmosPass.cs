...
namespace YPipeline
{
    internal sealed class PostGizmosPass : PipelinePass
    {
...
#endif
            {
                using (var builder = data.renderGraph.AddUnsafePass<GizmosPassData>("Draw Post Image Gizmos", out var passData))
                {
