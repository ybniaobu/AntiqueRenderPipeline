#ifndef YPIPELINE_SHARED_GBUFFER_PASS_INCLUDED
#define YPIPELINE_SHARED_GBUFFER_PASS_INCLUDED
...
GBufferOutput GBufferFrag(Varyings IN)
{
    ...
    OUT.gBuffer2 = float4(_Specular, metallic, 0.0, PackMaterialID(0.0)); // materialID is not used for now
